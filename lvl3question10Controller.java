...
public class lvl3question10Controller implements Initializable {
    @FXML
    AnchorPane root;//pane

    @FXML
    Button choice1;//right answer
    ...
    public void nextClicked() {
        ...
        try {
            game2pane = FXMLLoader.load(getClass().getResource("lvl3question9.fxml"));
        } catch (IOException e) {
    ...
    public void choice1Clicked() {
        choice1.setId("rightAnswer");
        choice2.setDisable(true);
        nextBtn.setDisable(false);
    }

    public void choice2Clicked() {
        choice2.setId("wrongAnswer");
